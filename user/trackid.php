...
?>
 ...
 include("connection.php");
  ...
  $query="SELECT * FROM complaint WHERE login_id='$r' AND status='0'";
  ...
  ?>
    ...
    <td><?php echo $value['c_id'];?></td>
     ...
     <td><?php echo $value['timestamp'];?></td>
      <td><a class="btn btn-success btn-xs" href="trackcomplain.php?tid=<?php echo $value['track_id'];?> " 
          onclick="return confirm('Sure to Track?');">Track Complain</a> </td>
   </tr>
            <?php
      }
