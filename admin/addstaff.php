  ...
  float: left;
    ...
    <section class="content-header">
      ...
      <?php
        ...
        if($_GET['flag']==1)
          {
            echo "<center><font style='color:green; text-align:center;font-size:20px'><b>Staff Added Successfully</b></font></center><br/>";
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="insertstaff.php" enctype="multipart/form-data" >
                <!-- text input -->
